...
public class ChatController {
    ...
    public SseEmitter stream(@RequestBody ChatStreamingRequest request) {
    ...
    private List<Message> toHistory(List<ChatStreamingRequest.ChatMessageDto> history) {
        List<Message> messages = new ArrayList<>();
        if (history == null) {
            return messages;
        }

        for (ChatStreamingRequest.ChatMessageDto item : history) {
